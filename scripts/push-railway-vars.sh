...
for key in \
  ...
  SLACK_BOT_TOKEN SLACK_APP_TOKEN GATEWAY_ALLOW_ALL_USERS WEBHOOK_SECRET \
  ...
  COPILOT_GITHUB_TOKEN GITHUB_TOKEN HONCHO_API_KEY GBRAIN_API_KEY \
  HERMES_MAIN_PROVIDER HERMES_MAIN_MODEL HERMES_DELEGATION_PROVIDER HERMES_DELEGATION_MODEL HERMES_DELEGATION_BASE_URL \
  HERMES_AUX_PROVIDER HERMES_AUX_MODEL HERMES_AUX_BASE_URL HERMES_AUX_CONTEXT_LENGTH \
  HERMES_MEMORY_PROVIDER HERMES_MEMORY_ENABLED HERMES_USER_PROFILE_ENABLED HERMES_OAUTH_PROVIDERS; do
